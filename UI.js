Base.write("UI",()=>{
  ...
  u.theme = {
    bg : Color(0,0,0.2),
    frame : Color(0.0,0.0,0.5),
    base : Color(0.2,0.5,0.7),
    front : Color(0.4,0.7,0.8),
    button : Color(0.4,0.5,1.0),
    shadow : Color(0.2,0.3,0.4),
    notify : Color(0.4,0.4,1.0),
    impact : Color(0.3,0.3,1.0),
    split : Color(0,0.3,0.6),
    def : Color(1,1,1),
    sharp : Color(0,0,1),
    in : Color(0,1,0),
    out : Color(0,1,1),
    invalid : Color(1.0,1.0,0),
    invalidShadow : Color(1.0,0.15,0),
    select : Color(0.5,0.9,1),
    exec : Color(0.5,1,0),
